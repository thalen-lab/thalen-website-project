...
const slides: CarouselSlide[] = [
  {
    ...
    subtitle: "Govern Smart. For 25 years, we have partnered with federal, state, and local agencies to modernize critical systems, secure sensitive data, and deliver superior citizen services.",
  },
  {
    id: 2,
    image: "/hero-fedramp-balance.png",
    title: "Thalen Technologies",
    subtitle: "Govern Smart. Accelerate your path to FedRAMP authorization with our battle-tested methodology. We've helped 15+ organizations achieve FedRAMP compliance in an average of 9 months.",
  },
  {
    id: 3,
    image: "/hero-defense-cyber.png",
    title: "Thalen Technologies",
    subtitle: "Govern Smart. Protect your DoD contracts with CMMC certification. Our comprehensive assessment and implementation services ensure you meet all cybersecurity requirements.",
  },
  {
    id: 4,
    image: "/images/hero-cloud-migration.png",
    title: "Thalen Technologies",
    subtitle: "Govern Smart. Modernize your infrastructure with secure migration to AWS GovCloud, Azure Government, or Google Cloud for Government with 99.99% uptime.",
  },
  {
    id: 5,
    image: "/hero-buildings.png",
    title: "Thalen Technologies",
    subtitle: "Govern Smart. We apply the same rigorous standards of security and compliance demanded by our government partners to solve challenges for regulated industries.",
  },
  {
    id: 6,
    image: "/hero-infrastructure.png",
    title: "Thalen Technologies",
    subtitle: "Govern Smart. Safeguarding and modernizing the nation's critical infrastructure with enterprise-grade security, resilience, and compliance frameworks.",
  },
];
