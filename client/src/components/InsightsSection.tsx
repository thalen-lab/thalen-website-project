...
export default function InsightsSection() {
  ...
  return (
    <section className="relative py-12 sm:py-14 md:py-16 lg:py-20 bg-white overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 lg:gap-8 mb-8 md:mb-10">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 mb-3">
              ...
              <span className="text-[#E07020] font-semibold text-xs uppercase tracking-[0.2em]">Insights</span>
            </div>
            
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#0A2540] mb-3 leading-[1.1] tracking-tight">
              Expert Perspectives
            </h2>
          ...
          >
            <Link href="/insights" className="group inline-flex items-center gap-2 text-[#0A2540] hover:text-[#E07020] font-semibold tracking-wider text-sm uppercase transition-colors">
              View All Insights
                ...
                <Card className="group h-full bg-white border border-slate-200 hover:border-[#E07020] transition-all duration-300 overflow-hidden cursor-pointer">
                  ...
                  <div className="relative aspect-[16/10] overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3">
                      <span className="inline-block px-3 py-1 bg-[#0A2540]/90 text-white text-xs font-semibold uppercase tracking-wider">
                        {insight.category}
                      </span>
                    </div>
                  </div>
                  ...
                  <CardContent className="p-5 md:p-6">
                    ...
                    {/* Title */}
                    <h3 className="text-lg md:text-xl font-bold text-[#0A2540] mb-2 leading-tight group-hover:text-[#E07020] transition-colors line-clamp-2">
                      {insight.title}
                    </h3>
                    ...
                    {/* Read More Link */}
                    <span className="inline-flex items-center gap-1.5 text-[#0A2540] group-hover:text-[#E07020] font-semibold text-xs uppercase tracking-wider transition-colors">
                      Read Article
                      <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                    </span>
                  </CardContent>
