    ...
    <section className="py-20 bg-slate-50">
      <div className="container">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 border border-slate-200 hover:border-[#FF6B35] transition-all duration-300 hover:shadow-xl group">
            <div className="mb-6">
            ...
            <Link href="/about">
              <Button variant="outline" className="group/btn border-[#0A2540] text-[#0A2540] hover:bg-[#FF6B35] hover:text-white hover:border-[#FF6B35] transition-all duration-300">
                Learn More
          ...
          <div className="bg-white p-8 border border-slate-200 hover:border-[#FF6B35] transition-all duration-300 hover:shadow-xl group">
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-[#0A2540] text-sm">SAM.gov Registered</p>
                  <p className="text-slate-600 text-sm">Ready to contract with UEI and CAGE code</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 bg-[#FF6B35] rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <p className="font-semibold text-[#0A2540] text-sm">Pursuing 8(a) Certification</p>
                  <p className="text-slate-600 text-sm">Application in progress for SBA Business Development Program</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 bg-[#FF6B35] rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <p className="font-semibold text-[#0A2540] text-sm">Small Business Partner</p>
                  <p className="text-slate-600 text-sm">Help agencies meet mandatory 23% small business contracting goals</p>
                </div>
              </div>
            </div>
