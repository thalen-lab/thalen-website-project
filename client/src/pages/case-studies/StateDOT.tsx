    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="py-20 bg-[oklch(0.97_0.01_250)]">
        <div className="container max-w-4xl">
          ...
          <h2 className="text-4xl font-bold text-[oklch(0.20_0.05_250)] mb-4 sm:mb-6 md:mb-4 sm:mb-6 md:mb-8">Legacy Systems and Modern Demands</h2>
      ...
      <section className="py-20">
        <div className="container max-w-4xl">
          ...
          <h2 className="text-4xl font-bold text-[oklch(0.20_0.05_250)] mb-4 sm:mb-6 md:mb-4 sm:mb-6 md:mb-8">A Cloud-First, Mobile-Ready Platform</h2>
      ...
      <section className="py-20 bg-[oklch(0.97_0.01_250)]">
        <div className="container max-w-4xl">
          ...
          <h2 className="text-4xl font-bold text-[oklch(0.20_0.05_250)] mb-4 sm:mb-6 md:mb-4 sm:mb-6 md:mb-8">Measurable Impact and Transformation</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-3 sm:p-4 md:p-6 rounded-lg border-2 border-slate-200">
