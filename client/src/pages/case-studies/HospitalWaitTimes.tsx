      ...
      <main className="flex-1 pt-32 pb-24">
        <article className="container max-w-3xl mx-auto px-6">
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-slate-600 leading-relaxed mb-6">
                Working with NexDyne Technology, the hospital deployed a patient flow optimization platform that integrated with the existing electronic medical records system to track every patient's journey from arrival through discharge. The platform provided real-time dashboards that showed patient locations, wait times, and treatment status, enabling staff to identify and address bottlenecks immediately.
              </p>
              <p className="text-slate-600 leading-relaxed mb-6">
