      ...
      <main className="flex-1 pt-32 pb-24">
        <article className="container max-w-3xl mx-auto px-6">
          ...
          <p className="text-xl md:text-2xl text-slate-600 leading-relaxed mb-12">
            How a Fortune 500 manufacturer transformed operations through predictive maintenance and industrial cybersecurity across fifty facilities. The initiative eliminated 75% of unplanned downtime and delivered an estimated $18M in annual savings.
          </p>
