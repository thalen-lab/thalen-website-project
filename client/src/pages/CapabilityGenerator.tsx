            ...
            <Card className="border-2">
              <CardContent className="p-12 space-y-8">
                ...
                <div className="text-center border-b pb-8">
                  <h1 className="text-4xl font-bold mb-2">NexDyne Technology</h1>
                  <p className="text-xl text-muted-foreground">Intelligence, Delivered</p>
