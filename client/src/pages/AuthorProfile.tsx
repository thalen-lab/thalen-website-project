...
const authors = {
  'sarah-chen': {
    ...
    bio: 'Sarah Chen leads NexDyne\'s automation strategy practice with over 15 years of experience helping federal agencies achieve measurable ROI through intelligent automation. She specializes in RPA implementation, process optimization, and change management for large-scale government transformations.',
  ...
  'michael-rodriguez': {
    ...
    bio: 'Michael Rodriguez is NexDyne\'s Chief Security Architect with 18 years of experience in federal cybersecurity. He leads zero-trust architecture implementations and FedRAMP compliance initiatives for defense and intelligence agencies. Michael holds multiple security certifications and regularly advises federal CISOs on emerging threats.',
  ...
  'david-thompson': {
    ...
    bio: 'David Thompson is a Cloud Architecture Principal at NexDyne with 14 years of experience designing multi-cloud strategies for federal agencies. He specializes in avoiding vendor lock-in while maintaining security and compliance across AWS, Azure, and Google Cloud platforms.',
  ...
  'lisa-martinez': {
    ...
    bio: 'Lisa Martinez directs digital transformation initiatives at NexDyne, bringing 16 years of experience in change management and organizational transformation. She has led successful transformations at multiple federal agencies, focusing on stakeholder engagement, communication strategies, and sustainable adoption.',
  ...
  'james-wilson': {
    ...
    bio: 'James Wilson serves as NexDyne\'s Chief Data Architect, specializing in real-time analytics platforms for government-scale data processing. With 17 years of experience, he designs systems that process billions of data points with sub-second latency while maintaining security and compliance.',
