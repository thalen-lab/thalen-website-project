    ...
    <div className="min-h-screen flex flex-col bg-white text-[oklch(0.20_0.05_250)]">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container">
          ...
          >
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">Certifications & Authorizations</h2>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">Our Security Principles</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
