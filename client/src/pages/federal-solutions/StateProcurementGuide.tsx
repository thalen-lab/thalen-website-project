  ...
  const procurementPaths = [
    {
      ...
      process: [
        ...
        'Review NexDyne\'s NASPO contract number and scope of services',
    ...
    },
    {
      ...
      process: [
        ...
        'Review NexDyne\'s Sourcewell contract #012345-ABC',
        'Complete Sourcewell registration (if not already registered)',
        'Issue purchase order directly to NexDyne'
      ],
    ...
    },
    {
      ...
      process: [
        ...
        'Review NexDyne\'s OMNIA contract R191902',
    ...
    },
    {
      ...
      process: [
        'Check if your state has a master agreement with NexDyne (contact us for list)',
        ...
        <div className="container">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl opacity-90 mb-8">
              Step-by-step guide to procuring NexDyne IT implementation services through cooperative purchasing contracts, state master agreements, RFP processes, and grant-funded projects.
            </p>
        ...
        <div className="container max-w-5xl">
          <div className="mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              For county and municipal governments requiring competitive RFP processes, NexDyne provides comprehensive response support with local references and transparent pricing.
            </p>
          </div>
      ...
      <section className="py-20 bg-secondary">
        <div className="container max-w-5xl">
          <div className="mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              NexDyne supports state and local agencies with federally-funded projects including ARPA, BEAD, and state-specific technology grants with compliance tracking and audit-ready documentation.
            </p>
          </div>
              ...
              <Card key={index} className="border-2">
                <CardContent className="p-8">
                  ...
                  <div className="bg-accent/10 p-4 rounded-lg">
                    <p className="text-sm"><span className="font-semibold">NexDyne Support:</span> {grant.support}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
