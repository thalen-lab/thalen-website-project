  ...
  const useCases = [
    {
      ...
      description: 'Analysts need to correlate data from dozens of sources, identify patterns, and brief leadership—all under time pressure. NexDyne builds custom intelligence workbenches that integrate SIGINT, HUMINT, OSINT, and other data streams into unified visual analysis environments.',
        ...
        <div className="container">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl opacity-90 mb-8">
              Federal operations do not run on last night's batch reports. When threats emerge, operations unfold, or crises develop, decision-makers need real-time intelligence—not data that is hours or days old. NexDyne builds mission-critical analytics platforms that deliver actionable insights in real-time with government-grade security. From intelligence analysis to operational command centers, our dashboards turn massive data streams into clear, actionable intelligence.
            </p>
      ...
      <section className="py-20">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              NexDyne has built real-time analytics platforms for intelligence, operations, fraud detection, and executive decision support.
            </p>
          </div>
