...
export default function CustomApplicationDevelopment() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <Navigation />
      {/* Hero Section */}
      <section className="relative text-white py-24 bg-cover bg-center" style={{backgroundImage: "url('/hero-pattern.svg')"}}>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="w-12 h-12 bg-[oklch(0.97_0.01_250)] rounded-lg flex items-center justify-center flex-shrink-0">
                  <span className="w-6 h-6 text-[oklch(0.65_0.18_55)]">#</span>
                </div>
                <div>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {capabilities.map((capability, index) => (
              ...
              >
                <h3 className="font-bold mb-4 text-[oklch(0.20_0.05_250)]">{capability.title}</h3>
            ...
            {developmentProcess.map((step, index) => (
              ...
              >
                <div className="flex items-start gap-6">
                  <div className="w-12 h-12 bg-[oklch(0.75_0.15_55)] text-white rounded-lg flex items-center justify-center flex-shrink-0 text-xl font-bold">
                    {index + 1}
                  </div>
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold mb-3 text-[oklch(0.20_0.05_250)]">{step.phase}</h3>
                    <p className="text-slate-600 mb-4">{step.description}</p>
                    <div className="flex flex-wrap gap-2">
                      {step.deliverables.map((deliverable, idx) => (
                        <span key={idx} className="bg-white px-3 py-1 rounded-full text-sm border border-slate-200 text-slate-600">
                          {deliverable}
                        </span>
                      ))}
                    </div>
