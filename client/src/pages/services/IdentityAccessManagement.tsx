        ...
        <div className="container">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl opacity-90 mb-8">
              Implement Zero Trust identity solutions with PIV/CAC authentication, privileged access management, and automated governance. NexDyne delivers federal-grade IAM that meets NIST 800-63 identity assurance requirements while improving user experience.
            </p>
      ...
      <section className="py-20 bg-navy-gradient text-primary-foreground">
        <div className="container text-center">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Schedule an IAM assessment and discover how NexDyne can deliver secure, compliant identity and access management for your federal environment.
          </p>
