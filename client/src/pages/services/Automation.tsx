...
export default function Automation() {
  ...
  const caseStudies = [
    {
      ...
      description: 'Implemented UiPath RPA platform with FedRAMP authorization, automating 85% of manual workflows while maintaining TS/SCI compliance. Estimated ~$4.2M contract with projected 6-month ROI.',
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative py-12 sm:py-10 sm:py-12 md:py-16 lg:py-24 lg:py-32 text-white overflow-hidden bg-[#0A2540]">
        {/* Background Image */}
        <div 
          className="absolute inset-0 bg-cover bg-center bg-no-repeat"
          style={{ backgroundImage: "url('/automation-hero.jpg')" }}
        ></div>
        {/* Navy gradient overlay for proper blue background */}
      ...
      <section className="py-10 sm:py-14 md:py-20 lg:py-28 bg-[oklch(0.97_0.01_250)]">
        <div className="container">
          ...
          >
            ...
            <h2 className="text-xl xs:text-2xl sm:text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold text-[oklch(0.20_0.05_250)] mb-4">Additional Automation Capabilities</h2>
          </motion.div>
