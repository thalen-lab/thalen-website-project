          ...
          <div className="max-w-4xl">
            <Link href="/services/cybersecurity">
              <div className="inline-flex items-center text-primary-foreground/80 hover:text-primary-foreground mb-4 text-sm">
                ...
                <span>Penetration Testing & Vulnerability Management</span>
              </div>
            </Link>
            ...
            <p className="text-xl md:text-2xl opacity-90 mb-8">
              Uncover security weaknesses before adversaries exploit them with comprehensive penetration testing and continuous vulnerability management. NexDyne's offensive security experts simulate real-world attacks to validate your defenses and prioritize remediation efforts.
            </p>
      ...
      <section className="py-20 bg-navy-gradient text-primary-foreground">
        <div className="container text-center">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Schedule a comprehensive penetration test and discover how NexDyne can identify and help remediate security weaknesses in your environment.
          </p>
