  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="relative py-20 text-white overflow-hidden">
        <div className="absolute inset-0 bg-[oklch(0.18_0.06_250)]/85 z-10"></div>
        ...
        <div className="container relative z-20">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8">
              Uncover security weaknesses before adversaries exploit them with comprehensive penetration testing and continuous vulnerability management for government agencies (federal, state, local) and defense contractors. NexDyne Technology's offensive security experts simulate real-world attacks to validate your defenses and prioritize remediation efforts.
            </p>
      ...
      <section className="py-20 bg-[oklch(0.22_0.06_250)] text-white">
        <div className="container text-center">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Schedule a comprehensive penetration test and discover how NexDyne Technology can identify and help remediate security weaknesses in your government environment.
          </p>
