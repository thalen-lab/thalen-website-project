          ...
          <div className="mb-4 sm:mb-6 md:mb-4 sm:mb-6 md:mb-8">
            <Breadcrumb 
              items={[
                ...
                { label: 'Government RPA Implementation' }
              ]} 
              variant="light" 
            />
          </div>
      ...
      <section className="py-10 sm:py-14 md:py-20 lg:py-28 bg-[oklch(0.97_0.01_250)]">
        <div className="container">
          ...
          >
            ...
            <h2 className="text-xl xs:text-2xl sm:text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold text-[oklch(0.20_0.05_250)] mb-4">Additional RPA Capabilities</h2>
          </motion.div>
      ...
      <section className="py-10 sm:py-14 md:py-20 lg:py-28 bg-[oklch(0.97_0.01_250)]">
        <div className="container">
          ...
          >
            ...
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              Our team members have delivered RPA solutions at leading government agencies. These projects were completed during their tenure at previous organizations.
            </p>
          </motion.div>
