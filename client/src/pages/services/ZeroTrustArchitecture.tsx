        ...
        <div className="container">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl opacity-90 mb-8">
              Implement modern Zero Trust security framework with micro-segmentation, continuous verification, and least-privilege access controls. NexDyne delivers NIST 800-207 and DoD Zero Trust Reference Architecture implementations for federal agencies eliminating implicit trust.
            </p>
