      ...
      <section className="py-20">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Why Government Agencies Choose NexDyne Technology</h2>
      ...
      <section className="py-20 bg-navy-gradient text-primary-foreground">
        <div className="container text-center">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Start with a comprehensive readiness assessment and discover how NexDyne Technology can accelerate your path to FedRAMP, StateRAMP, CMMC, or NIST compliance.
          </p>
